...
typedef union
{
    ...
    struct
    {
        ...
        u16 OffsetError     : 1;//偏置错误标志位256
        u16 StartError      : 1;//启动错误标志位512
				u16 NTCOPENError    : 1;//偏置错误标志位1024
        u16 NTCSHORTError   : 1;//启动错误标志位2048
...
extern void LED_flashing_alarm(u16 Blink_cnt,u8 Light_num,u16 Interval);
//extern void LED_flashing_alarm(u16 Blink_cnt,u8 Light_num,u16 Interval);
#endif
